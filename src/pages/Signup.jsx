      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-block">
            ...
            <p className="text-gray-500 text-sm mt-1 font-medium">Join the creator network</p>
          </Link>
        </div>
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-card">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm text-gray-600 mb-2 font-medium">Display Name</label>
              <input
                type="text"
                required
                value={displayName}
          ...
          <button
            ...
            disabled={loading}
            className="w-full rounded-xl border border-gray-300 bg-white px-4 py-3 text-sm font-medium hover:bg-gray-50 hover:border-gray-400 transition-all disabled:opacity-50 flex items-center justify-center gap-2 text-gray-700"
          >
          ...
          <div className="mt-6 text-xs text-gray-400 text-center">
            ...
            <a href="#" className="text-black hover:underline font-medium">Terms</a>
            {' '}and{' '}
        ...
        <div className="mt-6 text-center">
          <Link to="/" className="text-sm text-gray-500 hover:text-black transition font-medium">
            ← Back to home
          </Link>
        </div>
      </div>
